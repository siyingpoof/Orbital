...
class EventAdapterOrg extends RecyclerView.Adapter<EventAdapterOrg.ViewHolder> {

    private List<Event> mData;
    private Context mContext;
    private StorageReference storageReference;

    public EventAdapterOrg(List<Event> mData) {
        this.mData = mData;
    }

    @NonNull
    @Override
    public EventAdapterOrg.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
    ...
    @Override
    public void onBindViewHolder(@NonNull EventAdapterOrg.ViewHolder holder, int position) {
        ...
        holder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, Event_View_Org.class);
